// [resize][nebula] — verifica los 3 tamaños fijos (S/M/L) del chasis sobre NÉBULA (900×600 base)
// y deja snapshots /tmp/ovni_nebula_{s,m,l}.png para mirar a ojo. Headless (ScopedJuceInitialiser_GUI
...
TEST_CASE ("resize: NEBULA S/M/L tamaños exactos + snapshots", "[resize][nebula]")
{
