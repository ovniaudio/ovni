...
//
// Vive en el editor y sólo lo toca el MESSAGE THREAD (el hilo de decode produce la base y la entrega por
// callAsync) → sin locks. Acotado por bytes con expulsión LRU: una sesión de fotos de 12 MP no puede
