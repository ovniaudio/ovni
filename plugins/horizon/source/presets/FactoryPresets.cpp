...
// ⚠ Los presets NO setean FREEZE (QA 2026-07-16, OK de Joaquín): latchearlo en el preset
// congelaba SILENCIO si cargabas con el transporte parado (a MIX 100 la pista quedaba muda al
// dar play). FREEZE es EL gesto del usuario — el preset arma rate/whisper/spread y vos congelás.
...
namespace ovni::presets
{
    const std::vector<FactoryPreset>& factoryPresets()
    {
        ...
        static const std::vector<FactoryPreset> presets {
            ...
            // 1. Event Horizon — pad eterno bajo el track. Rate off (sostenido); apretá FREEZE con señal.
            { "Event Horizon", C::Production, {
                { pid::WHISPER, 10.f }, { pid::SPREAD, 55.f }, { pid::MIX, 60.f } } },

            // 2. Pulse 1/8 (Rhythmic → Production) — gate al octavo, esparcido.
            { "Pulse 1/8", C::Production, {
                { pid::RATESYNC, 1.f }, { pid::RATEDIV, 1.f },   // 1/8
            ...
            { "Trance Gate", C::Production, {
                { pid::RATESYNC, 1.f }, { pid::RATEDIV, 0.f },   // 1/16
            ...
            { "Ghost Choir", C::SoundDesign, {
                { pid::WHISPER, 85.f }, { pid::SPREAD, 80.f },
            ...
            { "Riser Gate", C::SoundDesign, {
                { pid::RATESYNC, 1.f }, { pid::RATEDIV, 2.f },   // 1/4
